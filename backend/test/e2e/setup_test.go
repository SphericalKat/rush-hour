...
func mustSeedDB() *sqlx.DB {
	...
	if _, err := db.Exec(`
		...
		INSERT INTO lines VALUES
			(1, 1, 'Main Line', 'CR-ML', 'suburban_rail'),
			(2, 2, 'Main Line', 'WR-ML', 'suburban_rail');
		...
		-- CR down trains
		INSERT INTO trains VALUES (1, 1, '90011', 'TNA', 0, 'down');
		INSERT INTO stops VALUES (1, 1, 1, 300, 0), (2, 1, 2, 330, 1), (3, 1, 3, 360, 2);

		INSERT INTO trains VALUES (2, 1, '90013', 'TNA', 0, 'down');
		INSERT INTO stops VALUES (4, 2, 1, 360, 0), (5, 2, 2, 390, 1), (6, 2, 3, 420, 2);

		-- CR up trains
		INSERT INTO trains VALUES (3, 1, '90012', 'CSMT', 0, 'up');
		INSERT INTO stops VALUES (7, 3, 3, 310, 0), (8, 3, 2, 340, 1), (9, 3, 1, 370, 2);

		-- WR down trains
		INSERT INTO trains VALUES (4, 2, '91001', 'BVI', 0, 'down');
		INSERT INTO stops VALUES (10, 4, 4, 320, 0), (11, 4, 5, 360, 1);

		-- Midnight-crossing train: departs CSMT at 23:40 (1420), Dadar 00:10 (1450)
		INSERT INTO trains VALUES (5, 1, '90099', 'TNA', 0, 'down');
		INSERT INTO stops VALUES (12, 5, 1, 1420, 0), (13, 5, 2, 1450, 1);

		-- AC train
		INSERT INTO trains VALUES (6, 1, '90021', 'TNA', 1, 'down');
		INSERT INTO stops VALUES (14, 6, 1, 480, 0), (15, 6, 2, 510, 1), (16, 6, 3, 540, 2);
	`); err != nil {
		panic(err)
	}
	return db
